...
export type CreateAngleSliderOptions = Record<string, unknown>
 ...
 *
 * const angleSlider = createAngleSlider({ openDelay: 200 })
 * return (
 *   <angleSlider.Root>
 *     ...
 *   </angleSlider.Root>
 ...
 * ```
 */
export function createAngleSlider(options: CreateAngleSliderOptions = {}) {
