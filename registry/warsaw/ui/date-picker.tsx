 ...
 * ```
 */
export function createDatePicker(options: Partial<zag.Props> = {}) {
	...
	return {
		...
		WeekNumberHeaderCell(props: DynamicAsProps<"div", zag.TableProps>) {
			...
			return (
				<Dynamic
					component={local.as ?? "div"}
					{...api().getWeekNumberHeaderCellProps({ view: local.view, columns: local.columns, id: local.id })}
					{...rest}
				/>
			);
		},
		WeekNumberCell(props: DynamicAsProps<"div", zag.WeekNumberCellProps>) {
			...
			return (
				<Dynamic
					component={local.as ?? "div"}
					{...api().getWeekNumberCellProps({ weekIndex: local.weekIndex, week: local.week })}
					{...rest}
				/>
			);
		},
		DayTableCell(props: DynamicAsProps<"div", zag.DayTableCellProps>) {
			...
			return (
				<Dynamic
					component={local.as ?? "div"}
					{...api().getDayTableCellProps({ value: local.value, disabled: local.disabled, visibleRange: local.visibleRange })}
					{...rest}
				/>
			);
		},
		DayTableCellTrigger(props: DynamicAsProps<"button", zag.DayTableCellProps>) {
			...
			return (
				<Dynamic
					...
					{...api().getDayTableCellTriggerProps({ value: local.value, disabled: local.disabled, visibleRange: local.visibleRange })}
					{...rest}
				/>
			);
		},
		MonthTableCell(props: DynamicAsProps<"div", zag.TableCellProps>) {
			...
			return (
				<Dynamic
					component={local.as ?? "div"}
					{...api().getMonthTableCellProps({ disabled: local.disabled, value: local.value, columns: local.columns })}
					{...rest}
				/>
			);
		},
		MonthTableCellTrigger(props: DynamicAsProps<"button", zag.TableCellProps>) {
			...
			return (
				<Dynamic
					component={local.as ?? "button"}
					{...api().getMonthTableCellTriggerProps({ disabled: local.disabled, value: local.value, columns: local.columns })}
					{...rest}
				/>
			);
		},
		YearTableCell(props: DynamicAsProps<"div", zag.TableCellProps>) {
			...
			return (
				<Dynamic
					component={local.as ?? "div"}
					{...api().getYearTableCellProps({ disabled: local.disabled, value: local.value, columns: local.columns })}
					{...rest}
				/>
			);
		},
		YearTableCellTrigger(props: DynamicAsProps<"button", zag.TableCellProps>) {
			...
			return (
				<Dynamic
					component={local.as ?? "button"}
					{...api().getYearTableCellTriggerProps({ disabled: local.disabled, value: local.value, columns: local.columns })}
					{...rest}
				/>
			);
		},
